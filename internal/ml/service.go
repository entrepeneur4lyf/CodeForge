...
func Initialize(cfg *config.Config) error {
	...
	if service.enabled {
		log.Println("🧠 ML Service: Initialized successfully with TD Learning")
	} else {
		log.Println("⚠️  ML Service: Initialized in disabled mode")
	}
...
func (s *Service) SetEnabled(enabled bool) {
	...
	if enabled {
		log.Println("🧠 ML Service: Enabled")
	} else {
		log.Println("🧠 ML Service: Disabled")
	}
}
...
func (s *Service) Shutdown() {
	...
	log.Println("🧠 ML Service: Shutdown complete")
}
